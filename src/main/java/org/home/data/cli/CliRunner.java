...
public class CliRunner implements ApplicationRunner {
    ...
    private final ObjectProvider<org.home.data.revx.DepthProbe> depthProbe;
    ...
    public CliRunner(ConfigurableApplicationContext context, CliMode mode,
                     ...
                     ObjectProvider<org.home.data.revx.DepthProbe> depthProbe,
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (args.containsOption("revx-depth-probe")) {
                depthProbe.getObject().run(firstOr(args, "symbol", "BTC-USDC"));
            }
            ...
            if (args.containsOption("revx-perp-basis")) {
                revx.getObject().perpBasis(
                        ...
                        java.time.Instant.parse(firstOr(args, "to",
                                java.time.Instant.now().toString())).toEpochMilli(),
                        firstOr(args, "out", "reports/revx_perp_basis.md"));
            }
