...
- **⚠️ Ботов на аккаунте ТРИ (с 02.09.2026).** `ExecLimits.BOTS_SHARING_ACCOUNT = 3`,
  ...
  **Почему так** (замер 09.09.2026, 13 суток 24.08–06.09, `docs/pairs/`):
  один уровень против трёх при ОДИНАКОВОМ капитале — у BTC три уровня не
  выиграли ни одного дня из тринадцати. ADA, ENA и PEPE отставлены: у ADA
  нет запаса между спредом и волатильностью, у ENA и PEPE нет потока
  (30 и 48 сделок на ленте в сутки).
