...
| | |
|---|---|
| Инструмент Kraken | `PF_CATIUSD` (перп, USD) |
| CoinGecko id | catizen |
| Капитализация | $37.17 млн |
| Цена | $0.0547 |
| Циркулирующее предложение | 679.35 млн |
| Всего / максимум | 1 млрд / 1 млрд |

## Что за монета

Catizen — игровая платформа в Telegram и TON. TGE сентябрь 2024.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для CATI нет.
...
**Нет.** Бесплатного машиночитаемого расписания для CATI не найдено.
