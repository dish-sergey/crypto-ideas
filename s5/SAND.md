...
| | |
|---|---|
| Инструмент Kraken | `PF_SANDUSD` (перп, USD) |
| CoinGecko id | the-sandbox |
| Капитализация | $109.34 млн |
| Цена | $0.03722372 |
| Циркулирующее предложение | 2.94 млрд |
| Всего / максимум | 3 млрд / 3 млрд |

## Что за монета

The Sandbox — виртуальный мир и земли, ICO 2020.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для SAND нет.
...
**Нет.** Бесплатного машиночитаемого расписания для SAND не найдено.
