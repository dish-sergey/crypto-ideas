...
| | |
|---|---|
| Инструмент Kraken | `PF_APEUSD` (перп, USD) |
| CoinGecko id | apecoin |
| Капитализация | $136.07 млн |
| Цена | $0.136107 |
| Циркулирующее предложение | 1 млрд |
| Всего / максимум | 1 млрд / 1 млрд |
| Теги | Ethereum (ETH) Token (ERC-20), NFT Token, Gaming |

## Что за монета

ApeCoin — токен экосистемы Yuga Labs и Bored Ape. TGE март 2022.

## Разлоки

**Статус: НАЙДЕНЫ.** Источник — DefiLlama emissions (бесплатно, без ключа).

- Протокол DefiLlama: `apecoin` («ApeCoin»)
- Категория / сеть: Yield / 
- Событий в расписании: **196** (прошедших 196, будущих cliff-событий 0)
...
|---|---|---|---|
| yuga labs | 15 | 15 | 100% |
| Jane Goodall Legacy Foundation | 1 | 1 | 100% |
| founders | 8 | 8 | 100% |
| launch contributors | 14 | 14 | 100% |
| ecosystem fund | 62 | 62 | 100% |
...
```
GET https://defillama-datasets.llama.fi/emissions/apecoin
```
