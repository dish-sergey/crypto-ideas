...
| | |
|---|---|
| Инструмент Kraken | `PF_RENDERUSD` (перп, USD) |
| CoinGecko id | render-token |
| Капитализация | $729.61 млн |
| Цена | $1.41 |
| Циркулирующее предложение | 518.77 млн |
| Всего / максимум | 533.53 млн / 644.25 млн |

## Что за монета

Render Network — децентрализованный GPU-рендеринг, миграция в Solana 2023.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для RENDER нет.
...
**Нет.** Бесплатного машиночитаемого расписания для RENDER не найдено.
