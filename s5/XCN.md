...
| | |
|---|---|
| Инструмент Kraken | `PF_XCNUSD` (перп, USD) |
| CoinGecko id | chain-2 |
| Капитализация | $129.25 млн |
| Цена | $0.00328815 |
| Циркулирующее предложение | 39.31 млрд |
| Всего / максимум | 53.4 млрд / 68.89 млрд |

## Что за монета

Onyxcoin — токен экосистемы Onyx, ребренд Chain.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для XCN нет.
...
**Нет.** Бесплатного машиночитаемого расписания для XCN не найдено.
