...
| | |
|---|---|
| Инструмент Kraken | `PF_SYNUSD` (перп, USD) |
| CoinGecko id | synapse-2 |
| Капитализация | $19.53 млн |
| Цена | $0.089129 |
| Циркулирующее предложение | 219.07 млн |
| Всего / максимум | 250 млн / 250 млн |

## Что за монета

Synapse — кроссчейн-мост с собственной эмиссией.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для SYN нет.
...
**Нет.** Бесплатного машиночитаемого расписания для SYN не найдено.
