...
| | |
|---|---|
| Инструмент Kraken | `PF_ANIMEUSD` (перп, USD) |
| CoinGecko id | anime |
| Капитализация | $15.36 млн |
| Цена | $0.00277338 |
| Циркулирующее предложение | 5.54 млрд |
| Всего / максимум | 10 млрд / 10 млрд |
| Теги | Ethereum (ETH) Token (ERC-20), Arbitrum Ecosystem, Collectibles, NFT Token |

## Что за монета

Animecoin — токен экосистемы Azuki и аниме-культуры. TGE январь 2025.
...
В открытом корпусе DefiLlama (`emissionsProtocolsList`, 372 протокола) адаптера для ANIME нет.
...
**Нет.** Бесплатного машиночитаемого расписания для ANIME не найдено.
